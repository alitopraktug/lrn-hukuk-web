...
- Klişe hukuk görselleri (terazi, tokmak, Themis, sütun, mahkeme salonu) ve lacivert-altın palet kullanılmaz. Marka rengi logo yeşilidir (`--forest`), bordo (`--wine`) yalnızca küçük vurgudur. Renkleri bileşenlerde sabit yazmayın; `app/globals.css` belirteçlerini kullanın.
