...
export const HOME_FIELDS: FieldDef[] = [
  ...
  { name: "processTitle", label: "Çalışma şeklimiz – başlık", type: "text", max: 80 },
  { name: "processIntro", label: "Çalışma şeklimiz – kısa açıklama", type: "textarea", max: 300, rows: 2 },
  { name: "process1Title", label: "Adım 1 – başlık", type: "text", max: 40 },
  { name: "process1Text", label: "Adım 1 – açıklama", type: "textarea", max: 240, rows: 2 },
  { name: "process2Title", label: "Adım 2 – başlık", type: "text", max: 40 },
  { name: "process2Text", label: "Adım 2 – açıklama", type: "textarea", max: 240, rows: 2 },
  { name: "process3Title", label: "Adım 3 – başlık", type: "text", max: 40 },
  { name: "process3Text", label: "Adım 3 – açıklama", type: "textarea", max: 240, rows: 2 },
...
export const HOME_DEFAULTS: Record<string, string> = {
  ...
  heroTitle: "Hukuki süreçlerde *açık iletişim* ve özenli çalışma.",
  heroLead:
  ...
  heroPrimaryCta: "Çalışma Alanlarını İnceleyin",
  heroSecondaryCta: "İletişim",
  aboutEyebrow: "LRN Hukuk",
  ...
  processIntro: "İlk başvurudan sürecin yürütülmesine kadar izlediğimiz genel akış aşağıdadır.",
  process1Title: "İlk Görüşme",
  process1Text: "Talebiniz ve elinizdeki bilgi/belgeler dinlenir; hukuki konunun kapsamı birlikte netleştirilir.",
  process2Title: "Değerlendirme",
  process2Text: "Belgeler ve olgular incelenir; izlenebilecek hukuki yol hakkında genel bilgi paylaşılır.",
  process3Title: "Süreç Yönetimi",
  process3Text: "Süreç boyunca gelişmeler hakkında düzenli olarak bilgilendirme yapılır.",
